...
void DualCarriageway::setSeparation_distance(int i) {				// Set seperation distance
	Separation_Distance = i;
}

int DualCarriageway::getSeparation_distance() {						// Get seperation distance
	return Separation_Distance;
}

void DualCarriageway::is_weather_bad(string s) {						// Separation distance is alrtered depnding
